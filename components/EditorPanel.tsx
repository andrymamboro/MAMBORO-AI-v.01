...
const EditorPanel: React.FC<Props> = ({ 
  ...
  return (
    <section className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700 backdrop-blur-sm shadow-xl space-y-6">
      ...
      <div>
        ...
        <textarea 
          ...
          placeholder="Contoh: 'Tambahkan matahari terbenam di latar belakang', 'Ubah warna baju menjadi merah'..."
          className="w-full bg-slate-900 border border-slate-700 rounded-xl p-4 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none h-32 resize-none"
        />
      </div>
